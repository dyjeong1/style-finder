...
### 현재 활성 PLAN
- `PLAN-20260420-위시리스트정렬추가`
- 상세 문서: `PLAN/PLAN-20260420-위시리스트정렬추가/PLAN.md`
- 기술 스펙: `PLAN/PLAN-20260420-위시리스트정렬추가/SPEC.md`
- 상태: `done` (위시리스트 정렬 옵션 추가 완료, 2026-04-20)
