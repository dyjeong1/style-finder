...
### 현재 활성 PLAN
- `PLAN-20260420-헤더상태표시정리`
- 상세 문서: `PLAN/PLAN-20260420-헤더상태표시정리/PLAN.md`
- 기술 스펙: `PLAN/PLAN-20260420-헤더상태표시정리/SPEC.md`
- 상태: `done` (헤더 배지 제거, 업로드 문구 수정, 허용 형식 안내 추가 완료, 2026-04-21)
