...
### 현재 활성 PLAN
- `PLAN-20260420-프론트폰트단위pt전환`
- 상세 문서: `PLAN/PLAN-20260420-프론트폰트단위pt전환/PLAN.md`
- 기술 스펙: `PLAN/PLAN-20260420-프론트폰트단위pt전환/SPEC.md`
- 상태: `done` (프론트 전역 폰트 pt 단위 전환 및 업로드 타이틀 36pt 적용 완료, 2026-04-20)
