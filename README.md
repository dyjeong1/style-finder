...
### 현재 활성 PLAN
- `PLAN-20260421-업로드미리보기조건부노출`
- 상세 문서: `PLAN/PLAN-20260421-업로드미리보기조건부노출/PLAN.md`
- 기술 스펙: `PLAN/PLAN-20260421-업로드미리보기조건부노출/SPEC.md`
- 상태: `done` (업로드 전 미리보기 숨김, 선택 후 정사각형 미리보기 노출 완료, 2026-04-21)
